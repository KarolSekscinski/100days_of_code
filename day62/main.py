...
class CafeForm(FlaskForm):
    ...
    wifi_rating = SelectField('Wi-Fi Rating', choices=["✘", "💪", "💪💪️", "💪💪💪", "💪💪💪💪", "💪💪💪💪💪️" ], validators=[DataRequired()])
...
def add_cafe():
    ...
    if form.validate_on_submit():
        ...
        with open('cafe-data.csv', "a", encoding='utf-8') as csv_file:
            text = (f"\n{form.data['cafe']},{form.data['location_url']},{form.data['open_time']},{form.data['close_time']},"
                    f"{form.data['coffee_rating']},{form.data['wifi_rating']},{form.data['power_rating']}")
            csv_file.write(text)
